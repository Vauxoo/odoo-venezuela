...
class baremo_discount(osv.osv):
    ...
    _columns = {
        ...
        'porc_disc': fields.float('% Dcto', digits=(16, int(config['price_accuracy'])), help="% de Descuento por producto", required=True),
        'porc_com': fields.float('% Com.', digits=(16, int(config['price_accuracy'])), help="% de Comision @ porcentaje Descuento", required=True),
